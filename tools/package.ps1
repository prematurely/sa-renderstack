...
function Copy-SdkStage {
    ...
    $files = @(
        ...
        [pscustomobject]@{ Source = 'README.pt-BR.md'; Destination = 'docs/README.pt-BR.md' },
        [pscustomobject]@{ Source = 'README.es.md'; Destination = 'docs/README.es.md' },
        [pscustomobject]@{ Source = 'README.ru.md'; Destination = 'docs/README.ru.md' },
...
try {
    ...
    $expectedMappings = @(
        ...
        'README.pt-BR.md|docs/README.pt-BR.md',
